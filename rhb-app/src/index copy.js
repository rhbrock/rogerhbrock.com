            ...
            <Navbar bg="dark" variant="dark" expand="lg" >
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="mr-auto">
                        <Nav.Link value={home} onClick={props.onClick}>
                            Home 
                        </Nav.Link>
                        <Nav.Link value={about} onClick={props.onClick}>About</Nav.Link>
                        <Nav.Link value={resume} onClick={props.onClick}>Resume</Nav.Link>
